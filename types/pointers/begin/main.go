...
func main() {
	...
	fmt.Println(*a) // Prints the actual value at the address
	fmt.Println(a)  // Prints the address
	// print out the value at the address of b
	fmt.Println(b)  // Prints the actual value
	fmt.Println(&b) // Prints the address
}
